...
**Sending phase**:
- Hand pirates are displayed as a fan of cards.
- Tap (touch) or hover (mouse) on a hand card to open the full effect card text.
- Player sends 0–2 pirates by dragging a hand card toward the island and releasing.
