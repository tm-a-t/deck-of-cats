...
- A route-primary buy that meets none of those setup gates still adds that pirate to discard, but does not mark the route secured, does not suppress the route-primary shop guarantee, gains no `Counter Watch`, and gains no prep `Might`.
