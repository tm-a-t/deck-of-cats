...
const TYPES = {
  // ---- starter ----
  lumberjack: {
    name: 'Lumberjack', cat: [6,37,46,17,0,6], str: 1, canIsland: true,
  ...
  miner: {
    name: 'Miner', cat: [10,26,39,16,0,9], str: 1, canIsland: true,
  ...
  adventurer: {
    name: 'Adventurer', cat: [8,27,41,16,0,8], str: 1, canIsland: true,
  ...
  slacker: {
    name: 'Deck Boy', cat: [5,25,38,16,0,1], str: 0, canIsland: false,
    island: null,
  ...
  tutorialForager: {
    name: 'Trail Forager', cat: [7,33,46,16,0,2], str: 1, canIsland: true,
  ...
  tutorialSwabbie: {
    name: 'Deck Swabbie', cat: [15,27,44,16,0,4], str: 1, canIsland: false,
    island: null,
    ship:   { cRes: null, cN: 0, pRes: 'enthusiasm', pN: 1 },
    cost: null,
    dI: '—', dS: '→ 1☠️',
  ...
  carpenter: {
    name: 'Carpenter', cat: [2,27,43,16,21,1], str: 1, canIsland: true,
  ...
  stonemason: {
    name: 'Stonemason', cat: [10,29,38,16,0,9], str: 1, canIsland: true,
  ...
  brute: {
    name: 'Brute', cat: [7,30,40,16,0,9], str: 2, canIsland: true,
    island: { res: 'wood', amt: 1, chance: 0.9 },
  ...
  scrapper: {
    name: 'Scrapper', cat: [6,32,41,16,0,6], str: 2, canIsland: true,
  ...
  deckhand: {
    name: 'Deckhand', cat: [4,32,41,16,0,9], str: 1, canIsland: true,
    island: { res: 'stone', amt: 1, chance: 0.9 },
  ...
  blacksmith: {
    name: 'Blacksmith', cat: [15,25,43,16,0,4], str: 2, canIsland: true,
    island: { res: 'wood', amt: 1, chance: 0.9 },
  ...
  bosun: {
    name: 'Bosun', cat: [11,28,46,16,0,6], str: 1, canIsland: false,
    island: null,
  ...
  cutthroat: {
    name: 'Cutthroat', cat: [3,35,38,19,0,3], str: 3, canIsland: true,
    island: { guaranteed: { res: 'enthusiasm', amt: 1 } },
  ...
  quartermaster: {
    name: 'Quartermaster', cat: [2,33,43,16,0,2], str: 4, canIsland: true,
    island: { recall: 1 },
  ...
  trader: {
    name: 'Trader', cat: [8,26,38,16,0,9], str: 1, canIsland: true,
  ...
  woodsman: {
    name: 'Woodsman', cat: [10,37,38,16,0,8], str: 2, canIsland: true,
    island: { res: 'wood', amt: 1, chance: 0.9 },
  ...
  prospector: {
    name: 'Prospector', cat: [8,28,40,16,0,0], str: 2, canIsland: true,
    island: { res: 'stone', amt: 1, chance: 0.9 },
  ...
  smuggler: {
    name: 'Smuggler', cat: [7,33,44,19,0,3], str: 2, canIsland: true,
  ...
  explorer: {
    name: 'Explorer', cat: [14,28,41,19,0,3], str: 1, canIsland: true,
  ...
  masterLumberjack: {
    name: 'Master Lumberjack', cat: [11,27,39,16,0,8], str: 3, canIsland: true,
  ...
  masterMiner: {
    name: 'Master Miner', cat: [10,34,38,16,0,0], str: 3, canIsland: true,
  ...
  masterAdventurer: {
    name: 'Treasure Hunter', cat: [10,25,44,16,0,9], str: 4, canIsland: true,
