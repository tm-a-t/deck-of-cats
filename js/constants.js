...
const TYPES = {
  ...
  carpenter: {
    name: 'Carpenter', cat: [8,33,43,16,0,6], str: 1, canIsland: true,
  ...
  stonemason: {
    name: 'Stonemason', cat: [7,35,41,16,0,5], str: 1, canIsland: true,
  ...
  brute: {
    name: 'Brute', cat: [9,24,39,16,0,2], str: 2, canIsland: true,
    island: { res: 'wood', amt: 1, chance: 0.9 },
  ...
  scrapper: {
    name: 'Scrapper', cat: [7,23,39,16,0,1], str: 2, canIsland: true,
  ...
  blacksmith: {
    name: 'Blacksmith', cat: [7,31,45,16,0,0], str: 2, canIsland: true,
    island: { res: 'wood', amt: 1, chance: 0.9 },
  ...
  bosun: {
    name: 'Bosun', cat: [4,34,40,19,0,3], str: 1, canIsland: false,
    island: null,
  ...
  cutthroat: {
    name: 'Cutthroat', cat: [4,25,38,17,0,2], str: 3, canIsland: true,
  ...
  quartermaster: {
    name: 'Quartermaster', cat: [14,37,39,16,0,6], str: 4, canIsland: true,
    island: { recall: 1 },
  ...
  woodsman: {
    name: 'Woodsman', cat: [11,25,44,16,0,8], str: 2, canIsland: true,
    island: { res: 'wood', amt: 1, chance: 0.9 },
  ...
  prospector: {
    name: 'Prospector', cat: [14,23,39,16,0,2], str: 2, canIsland: true,
    island: { res: 'stone', amt: 1, chance: 0.9 },
  ...
  explorer: {
    name: 'Explorer', cat: [4,29,40,16,0,6], str: 1, canIsland: true,
  ...
  masterLumberjack: {
    name: 'Master Rigger', cat: [10,24,39,16,0,2], str: 3, canIsland: true,
