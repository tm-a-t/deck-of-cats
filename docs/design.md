...
- Ship crew convert stockpiled resources into enthusiasm (the game's currency) and permanent weapons for future battles.

**Reward.** Rewards are immediate and visible: resource counters tick up and weapon icons appear. The player feels the compounding effect of earlier decisions — resources gathered three rounds ago become the weapons that will win the next fight.
...
To win the battles, the player has to balance between immediate economy and building up a better permanent arsenal.
...
| **Mid** | 9–18 | 5–10 ☠️/round | Building wood, stone, and gold chains. Buying Woodsmen, Prospectors, Armorers, and Navigators. Using Cutthroat to thin weaker pirates. |
| **Late** | 19+ | 10+ ☠️/round | Chasing Master-tier crew and high-payoff gold turns. Every hand should produce significant value and upgrade the crew's permanent weapons. |
