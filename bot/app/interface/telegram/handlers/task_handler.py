...
from app.interface.telegram.message_utils import derive_title_from_body, is_command_message, is_system_menu_input
...
def build_router(submit_use_case: SubmitChangeRequestUseCase) -> Router:
    ...
    async def create_task(message: Message, state: FSMContext) -> None:
        ...
        if text.startswith("/"):
            ...
            if is_command_message(command_token, "/new") and len(parts) > 1:
        ...
        title = derive_title_from_body(body)
